        ...
        NavigationView {
            VStack(spacing: 15) {
                TextField("Title", text: $habitModel.title)
                    .padding(.horizontal)
                    .padding(.vertical, 10)
                    .background(Color("TFPG").opacity(0.4), in: RoundedRectangle(cornerRadius: 6, style: .continuous))
                            ...
                            Text(day.prefix(2))
                                ...
                                .background {
                                    RoundedRectangle(cornerRadius: 10, style: .continuous)
                                        .fill(index != -1 ? Color(habitModel.habitColor) : Color("TFPG").opacity(0.4))
                                }
                                .onTapGesture {
                                    withAnimation {
                                        if index != -1 {
            ...
            if habitModel.showTimePicker {
                ZStack {
                    Rectangle()
                        ...
                        .onTapGesture {
                            withAnimation {
                                habitModel.showTimePicker = false
                            }
                        }
